...
const OrderConfirm = (props) => {
  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        <Dialog.Overlay className="fixed inset-0 bg-[#00000060]">
          <Dialog.Content
            onEscapeKeyDown={(e) => e.preventDefault()}
            onPointerDownOutside={(e) => e.preventDefault()}
            className="fixed left-1/2 top-1/2 max-h-[85vh] w-full -translate-x-1/2 -translate-y-1/2 overflow-y-auto rounded-lg bg-white p-6 Tablet:max-w-[500px] Desktop:w-[90vw] Desktop:max-w-[500px]"
          >
